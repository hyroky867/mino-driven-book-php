...
use App\Part6\Chapter3\GoldCustomerPolicy;
use App\Part6\Chapter3\PurchaseHistory;
use PHPUnit\Framework\TestCase;

class GoldCustomerPolicyTest extends TestCase
{
    private GoldCustomerPolicy $policy;

    protected function setUp(): void
    {
        parent::setUp();
        $this->policy = new GoldCustomerPolicy();
    }

    /** @test */
    public function 購入金額の履歴がルール違反している場合、falseが返るべき(): void
    {
        $amount = 99999;
